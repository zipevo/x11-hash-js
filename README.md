...
> Performs the [x7 hashing](https://docs.zip.org/en/latest/introduction/features.html#x7-hash-algorithm) algorithm used in the [Zip cryptocurrency](https://zip.org) in JavaScript.
...
```
$ npm install --save @zipevo/x7-hash-js
```

Reference the library within a Node module.

```js
var x7 = require('x7-hash-js');

console.log(x7.digest('The great experiment continues.'));
// -> '4da3b7c5ff698c6546564ebc72204f31885cd87b75b2b3ca5a93b5d75db85b8c'
```

Download the browserified library from the [dist](https://github.com/zippay/x7-hash-js/tree/master/dist) folder and include it in your HTML.

```html
<html>
<head>
  <script src='./dist/x7-hash.min.js'></script>
  <script>
  let x7 = require('x7hash');
  console.log(x7.digest('The great experiment continues.'));
  // -> '4da3b7c5ff698c6546564ebc72204f31885cd87b75b2b3ca5a93b5d75db85b8c'
  </script>
</head>
...
Call individual hash functions within the x7 digest.

```js
console.log(x7.blake('The great experiment continues.'));
...
console.log(x7.bmw('The great experiment continues.'));
...
console.log(x7.cubehash('The great experiment continues.'));
...
console.log(x7.echo('The great experiment continues.'));
...
console.log(x7.groestl('The great experiment continues.'));
...
console.log(x7.jh('The great experiment continues.'));
...
console.log(x7.keccak('The great experiment continues.'));
...
console.log(x7.luffa('The great experiment continues.'));
...
console.log(x7.shavite('The great experiment continues.'));
...
console.log(x7.simd('The great experiment continues.'));
...
console.log(x7.skein('The great experiment continues.'));
...
Returns a `string` representation of the x7 hash of an input `string` ***str***.
...
### x7.digest(input, inputFormat, outputFormat)

Returns the x7 hash of ***input*** with the input and output types variable between a `string`, 8 bit `array` or 32 bit `array`
