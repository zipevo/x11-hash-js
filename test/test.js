...
describe('X11 Hash Functions', function () {
    ...
    describe('x11 (digest)', function () {
        ...
        it('zip string', function () {
            expect(x11.digest(zip)).to.equal('fe809ebca8753d907f6ad32cdcf8e5c4e090d7bece5df35b2147e10b88c12d26');
        });
    ...
    describe('blake', function () {
        ...
        it('zip string', function () {
            expect(x11.blake(zip)).to.equal('d187e862889f3d3eb106e825b3ea4385f88a750cb6614d18219f9809ccd25874d46e856e741e334daf160270031280f61cca5c807ced7f4a7bf8beba1fd9a053');
        });
    ...
    describe('BMW', function () {
        ...
        it('zip string', function () {
            expect(x11.bmw(zip)).to.equal('4146f08952d34cb498486dc0a063939d7f7be69ede232f379f93c08091ea6d13d6ebdb4e06fe24030f7ca9ac07b8f59e5cfadbb05bded3b9bb3a9abecea031cb');
        });
    ...
    describe('cubehash', function () {
        ...
        it('zip string', function () {
            expect(x11.cubehash(zip)).to.equal('3258d531a2c1fd2006d67d739b7a15a249d9c8cdbeabe51561a38d02ebdd0f15f41b9515001d3993d8f462925b015d53494c5b4dc6e046647c6e8b6b620b4d15');
        });
    ...
    describe('echo', function () {
        ...
        it('zip string', function () {
            expect(x11.echo(zip)).to.equal('42a2ee2bb582f59d1be01e4a24ed31041aa1898a3c6c2efe6956e5c6b9eb33d4a9f390f6eccdb7c757d4cb6ad3d3aed302d97740fdf78f569f599ab8cd71ff49');
        });
    ...
    describe('groestl', function () {
        ...
        it('zip string', function () {
            expect(x11.groestl(zip)).to.equal('f4c9ce627e2ed9d79c6942e5ff22939048afa1e59ce2f1adeec3f22ea6e7d7f39b8b15c543a4eae74bf9df7a2e9a987dbb4d17537cbb26e994499cd5c22907df');
        });
    ...
    describe('jh', function () {
        ...
        it('zip string', function () {
            expect(x11.jh(zip)).to.equal('9999b3770256821e3a74c780ada66013df52378103addef0bceaac4be4f889d5ff93dc99d654310cc0063f15baa4ab168a2d8b6301104905619c334a92f521a1');
        });
    ...
    describe('keccak', function () {
        ...
        it('zip string', function () {
            expect(x11.keccak(zip)).to.equal('b166196bc60ee0a6d355d3b2e9418fd7b89d49308bdec6e78e3a47e126421966aacb875bd881b4c2987ae37b3cc31774aa2e2847c967f82338ce4046cb593eb6');
        });
    ...
    describe('luffa', function () {
        ...
        it('zip string', function () {
            expect(x11.luffa(zip)).to.equal('7181d2550acde547eff499c1d533293f6bf4a0464dd9f2264ff5f35e17bb3238a6f7eb036645119a7575627f65fd74288c9581f6cf8a8df034547900aa86d634');
        });
    ...
    describe('shavite', function () {
        ...
        it('zip string', function () {
            expect(x11.shavite(zip)).to.equal('45f24351ef4f5b7477214efe97f8cef4d69007e94e1e5f397011c4fecd4517fe69c509ea6aa758a9055dd6d0864b885498f4fdab5cc0458dbf98e7069b2c52dd');
        });
    ...
    describe('simd', function () {
        ...
        it('zip string', function () {
            expect(x11.simd(zip)).to.equal('e736a132375bd8aa02d00ea3ff3f0ef4cb8fbdd0b3cf3d619cf3e270896d2911105dc9bf46c395db98f17601529d24b8fa89a28e75f73da110d91a19c44f8975');
        });
    ...
    describe('skein', function () {
        ...
        it('zip string', function () {
            expect(x11.skein(zip)).to.equal('1db131ba5bc4b3ec9e381a752b3f0d53e8dd25e3d22aa8b9f17b570c3b5938833b91a54939ba873d28483e8b936f9584f06e80b1232a716a074377abd5c2b3f0');
        });
